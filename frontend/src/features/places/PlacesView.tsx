...
export function CategoryDetailView({ categoryId, categories, hideEmpty = false, busy, onOpenItem, onOpenCategory, onInventory, onCreateCategoryHere, onBack }: {
  ...
  const visibleChildren = hideEmpty ? contents.children.filter((child) => child.total_item_count > 0) : contents.children;
...
/** The last two levels of a path: the part that tells otherwise similar items apart. */
