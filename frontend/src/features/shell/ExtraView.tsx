...
export function ExtraView({
  ...
  return <section className="extra-page">
    ...
    <div className="extra-tool-grid">
      ...
      <button type="button" className="extra-tool-card" onClick={onCompatibility}><span><Icon name="tag" size={24} /></span><div><strong>Compatibility</strong><small>Machines, platforms and families your items work with.</small></div><Icon name="chevron" size={18} /></button>
